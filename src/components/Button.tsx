...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <motion.button
      ...
      className={`${className} relative overflow-hidden border-2 border-transparent bg-gradient-to-br from-[#62564e] to-primary-600 hover:text-primary-600 hover:bg-none hover:bg-yellow-500 hover:border-primary-600 rounded-xl text-primary-200 shadow-btn focus-visible:ring-2 ring-offset-2 ring-gray-950  active:after:bg-gradient-to-b active:after:from-transparent active:after:to-black/20 active:transform-onclick active:shadow-active-btn`}
      style={style}
