...
// --- Fetch GET URLs ---
export const ARTICLES_FETCH_URL = `${STRAPI_API_BASE_URL}${ARTICLES_ENDPOINT_BASE}${ARTICLES_POPULATE_PARAMS}&sort=position:asc`;
...
export const GALLERY_FETCH_URL = `${STRAPI_API_BASE_URL}${GALLERY_ENDPOINT_BASE}${ALL_POPULATE_PARAMS}&sort=position:asc`;
export const ABOUT_FETCH_URL = `${STRAPI_API_BASE_URL}${ABOUT_ENDPOINT_BASE}${ALL_POPULATE_PARAMS}&sort=position:asc`;
