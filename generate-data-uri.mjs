...
const inputDir = 'public/fallbackHomePage'; // Dossier contenant les images originales
const outputDir = 'public/fallbackHomePage/low-res'; // Dossier où seront enregistrées les images basse résolution
const jsonOutputFile = 'src/data/homepage/dataUris.json';
